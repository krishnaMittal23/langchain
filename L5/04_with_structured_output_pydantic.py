...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field(default=None, description="pros of review in a list")
    cons: Optional[list[str]] = Field(default=None, description="cons of review in a list")
